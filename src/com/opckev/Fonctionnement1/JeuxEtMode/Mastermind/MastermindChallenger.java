...
import com.opckev.Fonctionnement1.JeuxEtMode.Utils.ScoreUtils;
...
public class MastermindChallenger {
    ...
    public void mode4 (){
        ...
        //Chiffre à deviner proposer par l'ordinateur (ordi)
        ...
        int[][] chiffres = new int[NB_CHIFFRES][3];
        ...
        do {
            ...
            int vrai = ScoreUtils.comptage(NB_CHIFFRES,chiffres,solution);
            int present = ScoreUtils.comptage2(NB_CHIFFRES,chiffres,solution);
